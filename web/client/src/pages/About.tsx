...
export function About() {
  ...
  return (
    <div className="min-h-[calc(100vh-48px)] flex flex-col items-center justify-center p-6 md:p-12 relative">
      {/* About Card */}
      <section className="w-full max-w-2xl glass-card rounded-3xl p-10 border border-white/5 flex flex-col items-center text-center">
        {/* Logo */}
        <div className="mb-8 relative">
          <div className="w-28 h-28 rounded-[2rem] bg-gradient-to-tr from-av-surface-low to-av-background border border-white/10 flex items-center justify-center shadow-xl mx-auto mb-5">
          ...
          <div className="mt-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
            <span className="text-[10px] uppercase tracking-widest font-bold t-sub">Version</span>
            <span className="text-sm font-medium t-heading">{version}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mb-10">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-av-surface-high flex items-center justify-center t-sub group-hover:text-cyan-400 group-hover:bg-cyan-400/10 transition-colors">
              <span className="material-symbols-outlined" style={{fontFamily:'Material Symbols Outlined'}}>code</span>
            </div>
            <span className="text-sm font-medium t-body group-hover:t-heading transition-colors">GitHub 代码仓库</span>
          </a>
          <a
            href="#"
            className="group p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-cyan-400/30 transition-all duration-300 flex flex-col items-center gap-3"
          ...
          >
            ...
            <span className="text-sm font-medium t-body group-hover:t-heading transition-colors">反馈问题</span>
          </a>
        </div>
